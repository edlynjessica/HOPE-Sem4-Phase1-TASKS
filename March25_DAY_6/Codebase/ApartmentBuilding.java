...
3 has 4bhk attached restroom each two bedroom has common hall then  kitchen 
and common dinning common playground
*/
class Apartment{
    String type;
    // Constructor
...
// dpConstruct dpc= new dpConstruct()
//      ^       ^         ^
// classloader stack    heap
